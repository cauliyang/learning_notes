...
\newacronym{progan}{ProGAN}{Progressive Growing Generative Adversarial Networks}
\newacronym{stylegan}{StyleGAN}{Style-Based Generator Architecture for Generative Adversarial Networks}
\newacronym{sagan}{SAGAN}{Self-Attention Generative Adversarial Networks}
\newacronym{vqgan}{VQ-GAN}{Vector Quantized GAN}
\newacronym{vqvae}{VQ-VAE}{Vector Quantized Variational Autoencoder}
\newacronym{vitvqgan}{ViT VQ-GAN}{Vision Transformer Vector Quantized GAN}
\newacronym{vit}{ViT}{Vision Transformer}
\newacronym{musegan}{MuseGAN}{Multi-track Sequential Generative Adversarial Networks}
